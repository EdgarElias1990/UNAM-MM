...
#             payment_method_list = method_ids.ids
        ...
        records = self.env['account.move'].search([('invoice_date','>=',start),('invoice_date','<=',end),('is_payroll_payment_request','=',True),('payment_state','=','approved_payment'),('payment_place_id','!=',False),('l10n_mx_edi_payment_method_id','in',payment_method_list)])
        ...
        for place_id in payment_place_ids:
            ...
            move_ids = records.filtered(lambda a:a.payment_place_id.id==place_id.id).ids 
