...
#                 final_amount += header_intial
            ...
            count = 0
            show_avg = 0 
            for date_rec in range(day_diff):
                total_rec_inc += 1
                count += 1
                
                current_date_operation = current_opt_records.filtered(lambda x:x.date_required==new_date)
                if not current_date_operation:
                ...
                total_current_date_operation = len(current_date_operation)
                total_current_date_operation_inc = 0
                for rec in current_date_operation:
