    ...
    def _get_lines(self, options, line_id=None):
        ...
        for bank in account_payment.mapped("journal_id.bank_id"):
            ...
            for account in payment_accounts:
                expense_amount = sum(x.amount_payment_company_currency for x in account_payment.filtered(lambda x:x.journal_id.bank_id.id==bank.id and x.payment_issuing_bank_acc_id.id == account.id))
