...
#                                     liabilities_total_dict.update({pd: bal})
                ...
                string_assest = ''
                if line.code=='1.0.0.0':
                    string_assest = _('Total Assets')
                elif line.code=='2.0.0.0':
                    string_assest = _('Total Liabilities')
                elif line.code=='3.0.0.0':
                    string_assest = _('Total Public Finance / Equity')
        ...
        lines.append({
            'id': 'total_secound',
            'name': _('Total Liabilities and Finance Public / Equity'),
