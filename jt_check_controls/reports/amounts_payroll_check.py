...
class PayrollCheckAmounts(models.AbstractModel):
    ...
    def get_pdf(self, options, minimal_layout=True):
        ...
        options['mmtotal'] = True
        options['mmdiff'] = False
        totales = self.with_context(print_mode=True).get_html(options)

        options['mmtotal'] = False
        options['mmdiff'] = True
        body_html = self.with_context(print_mode=True).get_html(options)
        ...
        if body_html:
            ...
            dd = '<div class="text-left"><strong>SOLICITADO POR: &#160;  ___________________________________________</strong><br/><br/><strong>AUTORIZADO POR: &#160;  ___________________________________________</strong><br/><br/></div><span>PARA LA COORDINACION DE OPERACION POR BANCA ELECTRONICA</span><br/><br/><span style="float:right;"><b>Fecha de Emision : </b>'+ss+'</script></span>'
        ...
        #body = body.replace(b'<span class="account_report_line_name">', b'<span class="account_report_line_name" style="float:right;">')
        #body = body.replace(b'<span class="o_account_report_column_value">', b'<span class="o_account_report_column_value" style="float:right">')
        #body = body.replace(b'<th class="o_account_report_column_header " style="">', b'<th class="o_account_report_column_header text-right" style="">')

        body = body.replace(b'<td data-id="account_142" class="o_account_report_line o_account_report_line_indent " data-unfolded="True" colspan="1">',b'<td data-id="account_142" class="o_account_report_line o_account_report_line_indent" style="text-align: center;" data-unfolded="True" colspan="1">')
        body = body.replace(b'<td class="o_account_report_line  o_account_report_line_indent" style="">',b'<td class="o_account_report_line  o_account_report_line_indent" style="text-align: center;">')
        body = body.replace(b'<th class="o_account_report_column_header " style="">',b'<th class="o_account_report_column_header text-center" style="">')
        body = body.replace(b'<th class="o_account_report_column_header " style="">',b'<th class="o_account_report_column_header text-center" style="">')
        body = body.replace(b'<td data-id="account_126" class="o_account_report_line o_account_report_line_indent " data-unfolded="True" colspan="1">',b'<td data-id="account_126" class="o_account_report_line o_account_report_line_indent " data-unfolded="True" colspan="1" style="text-align: center;">')
        body = body.replace(b'<head>', b'<head> <style> .bordermm{border-top:thin solid;} </style>')

        #colum = '<tr class="bordermm"><td>TOTALES</td><td>&nbsp;</td><td><span class="o_account_report_column_value">&#160;&#160;&#160;&#160;&#160; $ &#160;' + str(totales) + '</span></td></tr></tbody>'

        #body = body.replace(b'</tbody>', str.encode(colum))
    ...
    def get_html(self, options, line_id=None, additional_context=None):
        ...
        * if line_id is set, the template used will be the line_template
        ...
        if options.get('mmdiff'):
            options['mmtotales'] = False
            options['mmdiffweb'] = True
            lines = self._get_lines(options, line_id=line_id)
        else:
            options['mmtotales'] = False
            options['mmdiffweb'] = False
            lines = self._get_lines(options, line_id=line_id)

        options['mmtotales'] = True
        options['mmdiffweb'] = False
        totales = self._get_lines(options, line_id=line_id)
        ...
        #html = html.replace(b'<td class="o_account_report_line  o_account_report_line_indent" style="">',b'<td class="o_account_report_line  o_account_report_line_indent" style="text-align: center;">')
        colum = '<tr style="border-top:thin solid;"><td style="border-top:thin solid;">TOTAL</td><td style="border-top:thin solid;">&nbsp;</td><td style="border-top:thin solid;"><span class="o_account_report_column_value">&#160;&#160;&#160;&#160;&#160; $ &#160;' + str(totales) + '</span></td><td style="border-top:thin solid;">&nbsp;</td></tr></tbody>'
        html = html.replace(b'</tbody>', str.encode(colum))

        if options.get('mmtotal'):
            return totales
        else:
            return html
